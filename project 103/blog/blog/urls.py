...
urlpatterns = [
    ...
    path('trainer/skip-split/<int:trainee_id>/', skip_trainee_split, name='skip_trainee_split_url'),
    ...
    path('feed/', feed_view, name='feed_url'),
    path('feed/create/', create_feed_post_page, name='create_feed_post_page_url'),
    path('feed/create/submit/', create_feed_post, name='create_feed_post_url'),
    path('feed/edit/<int:post_id>/', edit_feed_post, name='edit_feed_post_url'),
    path('feed/delete/<int:post_id>/', delete_feed_post, name='delete_feed_post_url'),
    path('feed/report/<int:post_id>/', report_feed_post, name='report_feed_post_url'),
    path('feed/hype/<int:post_id>/', hype_post, name='hype_post_url'),
    path('feed/hypers/<int:post_id>/', post_hypers_list, name='post_hypers_list_url'),
    path('feed/admin/', admin_feed_management, name='admin_feed_management_url'),
    path('feed/admin/remove/<int:post_id>/', admin_feed_post_remove, name='admin_feed_post_remove_url'),
    ]
from django.conf import settings
from django.conf.urls.static import static
